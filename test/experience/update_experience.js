...
describe('experience update', function() {
  ...
  it('updates a valid interaction', function testExperienceUpdateInteraction(done) {
    request(server)
      .post('/register')
      .set('Content-Type', 'application/json')
      .send('{"username": "myusername", "password": "MyPassword"}')
  ...
  it('updates a valid grouping', function testExperienceUpdateGrouping(done) {
    request(server)
      .post('/register')
      .set('Content-Type', 'application/json')
      .send('{"username": "myusername", "password": "MyPassword"}')
        ...
        request(server)
          ...
          .end(function() {
            ...
            request(server)
              ...
              .auth('myusername', 'MyPassword')
              .set('Content-Type', 'application/json')
              .send('{"id": 1, "groupDrug": 1, "groupCount": 25}')
              .end(function() {
                // make a drug
                request(server)
                  .post('/drug')
